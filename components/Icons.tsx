...
export const TrophyIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172V9.476c0-1.226-1.013-2.25-2.15-2.251h-.066c-1.136 0-2.15 1.025-2.15 2.251v2.727c0 1.162-.356 2.241-.982 3.172M9.497 14.625a4.865 4.865 0 00-1.185-1.574 5.255 5.255 0 01-1.375-3.451V9c0-2.485 2.015-4.5 4.5-4.5s4.5 2.015 4.5 4.5v.574c0 1.304-.555 2.495-1.446 3.325a4.816 4.816 0 00-1.118 1.226z" />
    </svg>
);
